...
void Initialize() {
	...
	Image* image = loadBMP("C:\Users\JHONY\Desktop\3d house\3D-House-using-OpenGL-and-C-\bricks.bmp");
	_textureBrick = loadTexture(image);
	image = loadBMP("C:\Users\JHONY\Desktop\3d house\3D-House-using-OpenGL-and-C-\\door.bmp");
	_textureDoor = loadTexture(image);
	image = loadBMP("C:\Users\JHONY\Desktop\3d house\3D-House-using-OpenGL-and-C-\grass.bmp");
	_textureGrass = loadTexture(image);
	image = loadBMP("C:\Users\JHONY\Desktop\3d house\3D-House-using-OpenGL-and-C-\roof.bmp");
	_textureRoof = loadTexture(image);
	image = loadBMP("C:\Users\JHONY\Desktop\3d house\3D-House-using-OpenGL-and-C-\.bmp");
	_textureWindow = loadTexture(image);
	image = loadBMP("\C:\Users\JHONY\Desktop\3d house\3D-House-using-OpenGL-and-C-\sky.bmp");
...
int main(int argc, char **argv) {
	...
	glutCreateWindow("Textured House by habib");
